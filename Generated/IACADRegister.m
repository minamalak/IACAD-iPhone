...
- (NSString *)requestGETParams {
	return [NSString stringWithFormat:@"?username=%@&password=%@&firstName=%@&lastName=%@&email=%@&mobile=%@&cityId=%d&passwordQuestion=%@&passwordAnswer=%@&culture=%@&", self.username, self.password, self.firstName, self.lastName, self.email, self.mobile, self.cityId, self.passwordQuestion, self.passwordAnswer, self.culture];
}
