...
+ (BlockAlertView *)alertWithTitleAndTextField:(NSString *)title message:(NSString *)message
{
    return [[[BlockAlertView alloc] initWithTitleAndTextField:title message:message] autorelease];
}
...
- (id)initWithTitleAndTextField:(NSString *)title message:(NSString *)message
{
    if ((self = [super init]))
    {
        UIWindow *parentView = [BlockBackground sharedInstance];
        ...
        if (title)
        {
            ...
            //            UITextField *TextField = [[UITextField alloc] initWithFrame:CGRectMake(kAlertViewBorder, _height, frame.size.width-kAlertViewBorder*2, size.height)];
            //            TextField.font = [UIFont fontWithName:@"Verdana-Bold" size:16];
            //            TextField.delegate = self;
            //            TextField.text = @"";
            //            if ([appDelegate.culture isEqualToString:@"en-US"])
            //            {
            //                TextField.textAlignment = UITextAlignmentLeft;
            //                //TextField.frame=CGRectMake(115,289,190,40);
            //            }
            //            else
            //            {
            //                TextField.textAlignment = UITextAlignmentRight;
            //                //TextField.frame=CGRectMake(12,299,235,40);
            //            }
            //            TextField.textColor=UIColorFromRGB(0xbe372b);
