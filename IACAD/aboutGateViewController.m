...
@interface aboutGateViewController ()

@end

@implementation aboutGateViewController
...
- (void)viewDidLoad
{
    ...
    if ([appDelegate.culture isEqualToString:@"ar"])
    {
        ...
        self.titleLbl.text = [converter convertArabic:NSLocalizedStringFromTable(@"gate_lbl",appDelegate.culture, @"")];
        self.titleLbl.font = boldFont;
    }
    else
    {
        self.titleLbl.text = NSLocalizedStringFromTable(@"gate_lbl",appDelegate.culture, @"");
    ...
    request.type = MobileContentTypeAboutECP;
